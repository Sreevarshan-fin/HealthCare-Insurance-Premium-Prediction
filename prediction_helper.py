...
model_young = joblib.load(r"C:\code\3_Project HealthCare Premium Prediction (ML)\Healthcare premium prediction App\artifacts\model_young.joblib")
model_rest = joblib.load(r"C:\code\3_Project HealthCare Premium Prediction (ML)\Healthcare premium prediction App\artifacts\model_rest.joblib")
scaler_young = joblib.load(r"C:\code\3_Project HealthCare Premium Prediction (ML)\Healthcare premium prediction App\artifacts\scaler_young.joblib")
scaler_rest = joblib.load(r"C:\code\3_Project HealthCare Premium Prediction (ML)\Healthcare premium prediction App\artifacts\scaler_rest.joblib")
